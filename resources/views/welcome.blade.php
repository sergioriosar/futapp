<!doctype html>
    <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <body>
                  ...
                  <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            @if (Route::has('login'))
                                ...
                                @else
                                    <a href="{{ route('login') }}" ><i class="fa fa-sign-in"></i> Ingresar</a>
                                    </a>
            ...
            <div class="main" style="background-image: url('images/futappBackground.png')">
            ...
            <!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
                    ...
                    <div class="content">
                        ...
                        <div class="subscribe">
                            <h5 class="info-text">
                                Suscríbete para recibir notificaciones de horarios y cancha disponible.
                            </h5>
                            <div class="row">
                ...
                <div class="footer">
                  <div class="container">
                        © Copyright <a href="http://www.futapp.com.ar">FutApp</a>.</a>
                  </div>
                </div>
             </div>
             </body>
